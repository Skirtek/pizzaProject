...
public enum Ingredient {
    ...
    TOMATO_SAUCE("sos pomidorowy", 0, false, false),
    ...
    TABASCO_SAUCE("tabasco", 0, false, true);
    ...
    Ingredient(String name, int price, boolean meat, boolean spicy) {
        this.name = name;
        this.price = price;
        this.meat = meat;
        this.spicy = spicy;
